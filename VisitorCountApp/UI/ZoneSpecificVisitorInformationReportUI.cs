...
namespace VisitorCountApp.UI
{
    public partial class ZoneSpecificVisitorInformationReportUI : Form
    {
        ...
        public void ShowSelectedZoneVisitors()
        {
            ...
            int id = aZone.Id;
            totalZoneSpecificTextBox.Text=zoneManager.GetSelectedZoneTotalVisitors(id).ToString();
            List<Visitor> totalVisitorList = visitorManager.GetSelectedZoneVisitor(id);
